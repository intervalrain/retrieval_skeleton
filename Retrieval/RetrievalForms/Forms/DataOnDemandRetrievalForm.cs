...
{
    public partial class DataOnDemandRetrievalForm : IRetrievalForm
    {
        public DataOnDemandRetrievalForm(DataOnDemandRetrievalSetting setting, DataTable masterTable)
        {
        }
